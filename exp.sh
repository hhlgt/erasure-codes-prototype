...
NUM=`expr $NUM - 1`
SRC_PATH1=/home/GuanTian/erasure-codes-prototype/run_cluster_sh/
SRC_PATH2=/home/GuanTian/erasure-codes-prototype/project
SRC_PATH3=/home/GuanTian/wondershaper

DIS_DIR1=/home/GuanTian/erasure-codes-prototype
...
if [ $1 == 1 ]; then
    ...
    do
        temp=${ARRAY[$i]}
        echo $temp
        ssh GuanTian@$temp 'cd /home/GuanTian/erasure-codes-prototype;bash cluster_run_datanode.sh;'
    ...
    do
        ...
        echo $temp
        if [ $temp != 'node18' ]; then
          ssh GuanTian@$temp 'cd /home/GuanTian/erasure-codes-prototype;bash cluster_run_proxy.sh;'
