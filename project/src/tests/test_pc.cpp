...
void test_pc(ProductCode *pc)
{
  ...
  test_pc_repair_plan(pc, FLAT);
  test_pc_repair_plan(pc, RANDOM);
  test_pc_repair_plan(pc, OPTIMAL);
}
...
void test_pc_repair_plan(ProductCode *pc, PlacementRule rule)
{
  ...
  pc->generate_repair_plan(failure_idxs, repair_plans);
